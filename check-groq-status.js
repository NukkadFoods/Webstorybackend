 ...
 * Tests all 6 Groq API keys to see if limits have refreshed
 */
...
async function checkAllKeys() {
  ...
  console.log(`✅ Active Keys: ${working}/6`);
  console.log(`⚠️  Rate Limited: ${rateLimited}/6`);
  console.log(`❌ Error/Not Configured: ${errors}/6`);
